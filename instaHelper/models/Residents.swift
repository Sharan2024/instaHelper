...
class AppResidentDataModel {
    ...
    init() {
        residents.append( Resident(houseOwner: "Sharan Sandhu", flatNumber: "110", towerNumber: "C", membershipID: "M53136", receivedBooking: [RecievedBookings(id: 5,name: "Shabham Javed", RequesterName: "Anish Gupta", dateandTime: "02-02-2024  10:00", cost: "500", status: "Not responded")], sentRequests: [RequestedBookings(id: 5, dateandTime: "02-02-2024", price: "500", address: "Home", status: "Approved", house: "Anish Gupta")], confirmed: []))
        residents.append( Resident(houseOwner: "Anish Gupta", flatNumber: "101", towerNumber: "A", membershipID: "M12345", receivedBooking: [RecievedBookings(id: 5,name: "Shabham Javed", RequesterName: "Sharan Sandhu", dateandTime: "02-02-2024  10:00", cost: "500", status: "Not responded")], sentRequests: [], confirmed: []))
